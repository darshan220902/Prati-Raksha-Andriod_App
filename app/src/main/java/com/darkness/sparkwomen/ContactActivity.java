...
public class ContactActivity extends AppCompatActivity {
    ...
    private void createContact(String contactString) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("MySharedPref",MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        Set<String> oldSet = sharedPreferences.getStringSet("enumbers", new HashSet<String>());
        Set<String> newStrSet = new HashSet<String>();
        newStrSet.add(contactString);
        newStrSet.addAll(oldSet);
        editor.putStringSet("enumbers",newStrSet);
        editor.commit();
        editor.apply();
...
//        editor.apply();
    ...
    private void getData() {
        ...
        Set<String> oldNumbers = new LinkedHashSet<>(sharedPreferences.getStringSet("enumbers", new HashSet<String>()));
